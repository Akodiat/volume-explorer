...
class XRButton {
	 ...
	 * @param {(session: any)=>void} sessionStartedCallback Function to call when session started
	 * @param {()=>void} sessionEndedCallback Function to call when session ended
	 * @returns
	 */
	static createButton( renderer, sessionInit = {}, sessionStartedCallback = ()=>{}, sessionEndedCallback = ()=>{} ) {
		...
		function showStartXR( mode ) {
			...
			async function onSessionStarted( session ) {
				...
				sessionStartedCallback(session);
